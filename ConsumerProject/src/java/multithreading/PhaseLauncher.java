    ...
    public void run() {
     ...
     private void sendRequest(){
        ...
        try { // Call Web Service Operation
            ...
            Thread messageThread = new Thread(new MessageSender(port, thePhase.getIdPhase(), ConsumerWebService.CONSUMER_ID, thePhase.getPayloadSize(), thePhase.getTargetConfig(), messageId));
            messageThread.start();
